        ...
        {showMenu && (
          ...
          >
            <motion.div
              ...
              animate={{ y: 0, opacity: 1 }}
              transition={{ duration: 0.1 }}
              className="w-[80%] h-full overflow-y-scroll -scrollbarHide bg-[#201F1F] flex flex-col items-center px-4 py-10 relative"
            >
              <MdOutlineClose
                onClick={() => setShowMenu(false)}
                className="text-3x1 text-textGreen cursor-pointer hover:text-red-500 absolute top-4 right-4"
              />
              ...
              <motion.a
                ...
                className="text-sm w-72 tracking-widset text-textGreen text-center mt-4"
                href="mailto:info@keravnos.co"
              >
                <p>info@keravnos.co</p>
              </motion.a>
            </motion.div>
          </div>
        )}
